...
const NotFound = () => {
    ...
    <div className='notfound-div'>
        <svg className='notfound-svg' width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect id="background" x="30" y="26" width="1063" height="777" rx="20" fill="#003366"/>
            <g id="stars">
            ...
            <path id="Vector_20" opacity="0.1" d="M665.261 656.998H682.881L681.701 648.948H666.441L665.261 656.998Z" fill="#003366"/>
            </g>
            ...
            <path id="Vector_34" d="M578.51 96.4834L578.52 96.4957L578.531 96.5076C583.685 102.221 590.434 111.588 597.797 126.726L597.798 126.73C613.465 158.638 621.544 194.732 621.655 231.32L622.93 650.608L517.93 650.927L516.661 233.319C516.547 195.664 524.762 158.515 541.048 125.774C546.594 114.716 552.917 104.371 559.813 96.561L559.822 96.5507L559.831 96.5402C560.972 95.1742 562.398 94.0744 564.009 93.3179C565.62 92.5615 567.377 92.1667 569.157 92.1613C570.937 92.1559 572.697 92.54 574.312 93.2866C575.928 94.0333 577.361 95.1244 578.51 96.4834Z" fill="#EEEEEE" stroke="#003366" stroke-width="2"/>
    ...
    {location?.pathname === "/quota-exceeded"?  <div className="text">
        <h1 className='notfound-h1'>429 Error</h1>  
      <h2 className='text-lg my-2'>Couldn't launch :(</h2>
         <h3>It happens because of my free API usage limit (500 API calls/day) has been exceeded for today :(. <br /> <span className='notfound-a'>Please try again tomorrow....</span></h3> 
    </div> : 
    <div className="text">
        <h1 className='notfound-h1'>404 Error</h1>  
      <h2>Couldn't launch :(</h2>
         <h3>Page Not Found - lets take you <a href="/" className='notfound-a'>BACK</a></h3> 
    </div>}
</div>
